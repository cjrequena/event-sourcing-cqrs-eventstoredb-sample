...
public class Constants {
  ...
  /** AGGREGATES */
  public static final String BANK_ACCOUNT_AGGREGATE_NAME = "BANK-ACCOUNTS";
  public static final String BANK_ACCOUNT_AGGREGATE_EVENT_STORE_STREAM_PREFIX = BANK_ACCOUNT_AGGREGATE_NAME + "-";
